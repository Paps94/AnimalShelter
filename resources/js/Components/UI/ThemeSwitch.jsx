...
export default function ThemeSwitch() {
    ...
    return (
        <button
            className="fixed -left-2 top-1/2 z-40 dark:bg-yellow-400 bg-orange-400 p-3 rounded-full cursor-pointer 
                        before:fixed before:top-1/2 before:h-[52px] before:left-0 before:w-6 before:dark:bg-yellow-400 before:bg-orange-400 before:rounded-l-none before:rounded-lg
